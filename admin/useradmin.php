...
<fieldset class="border p-2 mt-4">
		...
		<table class="table">
		    ...
		    <tr>
		      ...
		      <td> <a type="button" class="btn btn-warning" href="?mod=useradmin&act=edit&id=<?php echo $row['ID']; ?>">Ubah</a> / <a type="button" class="btn btn-danger"href="?mod=useradmin&act=hapus&id=<?php echo $row['ID']; ?>">Hapus</a></td>
		    </tr>
		    <?php $i++; ?>
			<?php endwhile; ?>
		  	</tbody>
