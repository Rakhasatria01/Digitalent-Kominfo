		...
		<table class="table">
		  	...
		  	<tbody>
		  		...
		  		<tr>
		  			...
		  			<td><?= $row['kategori']; ?></td>
		  			<td><?= $row['tanggal']; ?></td>
		  			<td><a type="button" class="btn btn-warning"href="./?mod=berita&act=edit&id=<?= $row['ID']; ?>">Edit</a><a type="button" class="btn btn-danger" href="./?mod=berita&act=hapus&id=<?= $row['ID']; ?>">Hapus</a></td>
		  		</tr>
		  		<?php $no++; ?>
		  		<?php endwhile; ?>
		  	</tbody>
