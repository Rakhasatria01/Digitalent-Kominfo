...
! function () {
    ...
    var z = (c.navigator || {}).userAgent,
        ...
        m = c,
        v = l,
        a = (m.document, !!v.documentElement && !!v.head && "function" == typeof v.addEventListener && v.createElement, ~h.indexOf("MSIE") || h.indexOf("Trident/"), "___FONT_AWESOME___"),
        M = function () {
            try {
                return !0
            } catch (c) {
    ...
    function V(c, h) {
        ...
        "function" != typeof H.hooks.addPack || z ? H.styles[c] = function (m) {
            for (var c = 1; c < arguments.length; c++) {
                ...
                "function" == typeof Object.getOwnPropertySymbols && (l = l.concat(Object.getOwnPropertySymbols(v).filter(function (c) {
                    ...
                    var l, z, h;
                    l = m, h = v[z = c], z in l ? Object.defineProperty(l, z, {
                        value: h,
                        enumerable: !0,
                        configurable: !0,
                        writable: !0
            ...
            return m
        }({}, H.styles[c] || {}, m) : H.hooks.addPack(c, m), "fas" === c && V("fa", h)
    }
    var e = {
