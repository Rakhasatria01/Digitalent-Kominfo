...
! function (t, e) {
    ...
    function le(t, e) {
        ...
        if (!i) return;
        const n = i.listeners,
            o = n.indexOf(e); - 1 !== o && n.splice(o, 1), n.length > 0 || (ae.forEach((e => {
            delete t[e]
        })), delete t._chartjs)
    }
    ...
    function me(t, e) {
        ...
        } = e, o = ue(i), s = "border-box" === o.boxSizing, a = pe(o, "padding"), r = pe(o, "border", "width"), {
            x: l,
            y: c,
            box: h
        } = function (t, e) {
    ...
    var Ke = {
        ...
        update(t, e, i, n) {
            ...
            const o = Ie(t.options.layout.padding),
                ...
                r = function (t) {
                    const e = function (t) {
                        ...
                        i = He(e.filter((t => t.box.fullSize)), !0),
                        n = He(We(e, "left"), !0),
                        o = He(We(e, "right")),
                        s = He(We(e, "top"), !0),
                        a = He(We(e, "bottom")),
            ...
            }(l.concat(c), d), Xe(r.fullSize, f, d), Xe(l, f, d), Xe(c, f, d) && Xe(l, f, d),
                function (t) {
    ...
    const ui = t => 0 === t || 1 === t,
        fi = (t, e, i) => -Math.pow(2, 10 * (t -= 1)) * Math.sin((t - e) * bt / i),
    ...
    class Ti {
        ...
        updateRangeFromParsed(t, e, i, n) {
            ...
            n && a && (n.values = a, t.min = Math.min(t.min, s), t.max = Math.max(t.max, s), s = Mi(n, o, this._cachedMeta.index, {
                all: !0
            ...
            if (a) {
                ...
                if (r ? (e.width = t.maxWidth, e.height = Hi(s) + a) : (e.height = t.maxHeight, e.width = Hi(s) + a), n.display && t.ticks.length) {
                    const {
                        ...
                        widest: s,
                        highest: a
                    } = t._getLabelSizes(), l = 2 * n.padding, c = Lt(t.labelRotation), h = Math.cos(c), d = Math.sin(c);
                    if (r) {
    ...
    function Ui(t, e = [""], i = t, n, o = (() => t[0])) {
        ...
        return new Proxy(s, {
            ...
            get: (i, n) => Zi(i, n, (() => function (t, e, i, n) {
                let o;
                for (const s of e)
                    if (o = on(Ki(s, t), i), ht(o)) return Gi(t, o) ? en(i, n, t, o) : o
            }(n, e, t, i))),
    ...
    function dn(t, e, i, n) {
        let o, s, a, r;
        if (e.spanGaps && (t = t.filter((t => !t.skip))), "monotone" === e.cubicInterpolationMode) cn(t);
        else {
    ...
    class Zn {
        ...
        _resize(t, e) {
            ...
            i.width === a.width && i.height === a.height && r === l || (i.width = a.width, i.height = a.height, i._aspectRatio = i.aspectRatio, _e(i, l, !0), i.notifyPlugins("resize", {
                size: a
        ...
        buildOrUpdateControllers() {
            ...
            for (t._removeUnreferencedMetasets(), n = 0, o = i.length; n < o; n++) {
                ...
                if (s.type && s.type !== a && (t._destroyDatasetMeta(n), s = t.getDatasetMeta(n)), s.type = a, s.indexAxis = o.indexAxis || Rn(a, t.options), s.order = o.order || 0, t._updateMetasetIndex(s, n), s.label = "" + o.label, s.visible = t.isDatasetVisible(n), s.controller) s.controller.updateIndex(n), s.controller.linkScales();
                else {
        ...
        update(t) {
            ...
            e._minPadding = s, e._updateLayout(s), n || J(o, (t => {
                ...
                mode: t
            }), e._layers.sort($n("z", "_idx")), e._lastEvent && e._eventHandler(e._lastEvent, !0), e.render()
        }
        _updateLayout(t) {
            const e = this;
        ...
        render() {
            ...
            !1 !== t.notifyPlugins("beforeRender", {
                cancelable: !0
            }) && (a.has(t) ? t.attached && !a.running(t) && a.start(t) : (t.draw(), Yn({
                chart: t
            })))
        }
        draw() {
    ...
    function yo(t, e) {
        const {
            ...
            innerStart: d,
            innerEnd: u
        } = bo(e, l, r, s - o), f = r - c, g = r - h, p = o + c / f, m = s - h / g, x = l + d, b = l + u, _ = o + d / x, y = s - u / b;
            ...
            for (const t of n) {
                ...
                for (const e of r) {
                    ...
                    for (const t of l) a.push({
                        ...
                        target: e,
                        start: {
                            [i]: os(n, r, "start", Math.max)
                        },
                        end: {
                            [i]: os(n, r, "end", Math.min)
                        }
                    })
                }
            }
    ...
    class ds extends Ri {
        ...
        _draw() {
            ...
            const {
                ...
                boxHeight: b,
                itemHeight: _
            } = hs(l, g), y = t.isHorizontal(), v = this._computeTitleHeight();
            m = y ? {
    ...
    class Ts extends Yi {
        ...
        buildTicks() {
            ...
            const o = function (t, e) {
                ...
                for (f && (i.push({
                        value: o
                    }), x <= o && v++, At(Math.round((x + v * y) * m) / m, o, y / 10) && v++); v < _; ++v) i.push({
                    value: Math.round((x + v * y) * m) / m
                });
                return g ? At(i[i.length - 1].value, s, y / 10) ? i[i.length - 1].value = s : i.push({
                    value: s
                }) : i.push({
                    value: b
                }), i
