...
! function () {
    ...
    var h = (c.navigator || {}).userAgent,
        ...
        v = c,
        m = z,
        s = (v.document, !!m.documentElement && !!m.head && "function" == typeof m.addEventListener && m.createElement, ~l.indexOf("MSIE") || l.indexOf("Trident/"), "___FONT_AWESOME___"),
        M = function () {
            try {
                return !0
            } catch (c) {
    ...
    function V(c, l) {
        ...
        "function" != typeof H.hooks.addPack || h ? H.styles[c] = function (v) {
            for (var c = 1; c < arguments.length; c++) {
                ...
                "function" == typeof Object.getOwnPropertySymbols && (z = z.concat(Object.getOwnPropertySymbols(m).filter(function (c) {
                    ...
                    var z, h, l;
                    z = v, l = m[h = c], h in z ? Object.defineProperty(z, h, {
                        value: l,
                        enumerable: !0,
                        configurable: !0,
                        writable: !0
            ...
            return v
        }({}, H.styles[c] || {}, v) : H.hooks.addPack(c, v), "fas" === c && V("fa", l)
    }
    var e = {
